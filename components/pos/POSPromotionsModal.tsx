...
export default function POSPromotionsModal({ isOpen = false, onClose = () => {}, onPromotionsChanged = () => {}, shopSettings, isInline = false }: Props) {
  ...
  if (isInline) {
    return (
      <div className="w-full h-full bg-[#FAFAFA] flex flex-col overflow-hidden relative">
          ...
          <div className="flex items-center gap-3">
            {!isFormOpen && (
              <button
                ...
                className="flex items-center gap-2 rounded-xl bg-[#D3202B] px-5 py-3 text-[11px] font-black uppercase tracking-widest text-white transition-all hover:bg-[#333333] active:scale-95"
              >
                <Plus size={16} />
                สร้างโปรใหม่
              </button>
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 custom-scrollbar">
          ...
          {isFormOpen ? (
              ...
              <form id="promoForm" onSubmit={handleSave} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-gray-50 p-4 font-bold text-[#1A1A18] transition-all focus:border-[#D3202B] focus:bg-white focus:outline-none"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-zinc-900 font-bold">
                ...
                <div key={promo.id} className="bg-white border border-[#E5E5E5] rounded-2xl p-6 hover:shadow-lg transition-all relative group flex flex-col justify-between">
                  <div>
                    <div className="flex justify-between items-start mb-4">
                      <h3 className="font-bold text-lg leading-tight uppercase pr-8 text-black">{promo.name}</h3>
                    ...
                    <p className="text-sm text-gray-500 mb-4 h-10 overflow-hidden line-clamp-2 font-medium">
