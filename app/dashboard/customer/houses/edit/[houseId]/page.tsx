              ...
              <label className="flex flex-col items-center justify-center border-2 border-dashed border-[#E5E5E5] p-8 cursor-pointer hover:border-[#111111] transition-colors bg-white">
                {formData.image_url ? (
                  <div className="relative w-full h-64 group">
                    <img crossOrigin="anonymous"  src={formData.image_url ? `${formData.image_url}?v=8` : ''} alt="Preview" className="w-full h-full object-cover transition-opacity group-hover:opacity-50" />
