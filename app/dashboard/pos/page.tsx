  ...
  useEffect(() => {
    ...
    const triggerPrintForOrder = async (orderId: string, newItemIds?: string[]) => {
      ...
      const shopData = {
        ...
        receiptHeader: freshSettings?.opening_hours?.receipt_header || freshSettings?.receipt_header || shopSettings?.opening_hours?.receipt_header || shopSettings?.receipt_header,
        receiptFooter: freshSettings?.opening_hours?.receipt_footer || freshSettings?.receipt_footer || shopSettings?.opening_hours?.receipt_footer || shopSettings?.receipt_footer,
