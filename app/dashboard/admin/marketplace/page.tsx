                      ...
                      <td className="px-4 py-4">
                        <div className="flex items-center gap-4">
                          <div className="h-16 w-12 overflow-hidden bg-[#F0EFEA]">
                            {plant.image_url ? (
                              <img  src={plant.image_url ? `${plant.image_url}?cb=2` : ''} alt={plant.name} className="h-full w-full object-cover" />
                            ) : (
                    ...
                    <section>
                      ...
                      <div className="flex flex-wrap gap-3">
                        ...
                        <div className="h-28 w-28 overflow-hidden border border-[#E8E6E1] bg-[#F0EFEA]">
                          {form.image_url ? (
                            <img  src={form.image_url ? `${form.image_url}?cb=2` : ''} alt="preview" className="h-full w-full object-cover" />
                          ) : (
                            <div className="flex h-full w-full items-center justify-center text-[10px] text-[#A5A39E]">{pickLocalizedText(locale, copy.noImage)}</div>
                          )}
                        </div>
              ...
              <aside className="space-y-5">
                <section className="overflow-hidden border border-[#E8E6E1] bg-white">
                  <div className="aspect-[4/3] bg-[#F0EFEA]">
                    {form.image_url ? (
                      <img  src={form.image_url ? `${form.image_url}?cb=2` : ''} alt={form.name || 'preview'} className="h-full w-full object-cover" />
                    ) : (
