...
export default function LiffMemberPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#111111] font-sans overflow-x-hidden pb-32">
      ...
      <main className="px-6 max-w-lg mx-auto">
        ...
        {/* Dividers & Sections */}
        <div className="w-full h-[1px] bg-[#F5F5F5] my-16" />
                ...
                <div className="space-y-4">
                    {coupons.map(c => (
                        <div key={c.id} className="border border-[#E5E5E5] p-6 flex justify-between items-center group cursor-pointer hover:border-[#111111] transition-colors">
                            ...
                            <div className="text-[10px] uppercase tracking-[0.2em] text-[#111111] opacity-0 group-hover:opacity-100 transition-opacity">
                                Active
                            </div>
                        </div>
                    ))}
        ...
        <div className="mb-16">
            ...
            <div className="grid grid-cols-2 gap-px bg-[#F5F5F5] border border-[#F5F5F5]">
