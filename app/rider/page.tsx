...
export default function RiderPage() {
  ...
  if (authLoading || profileLoading) {
    return (
      <div className="flex h-screen w-full items-center justify-center bg-[#121214]">
        <div className="flex flex-col items-center gap-3">
          <Loader2 className="h-8 w-8 animate-spin text-[#C62229]" />
          <p className="text-xs font-bold text-zinc-400 uppercase tracking-widest">กำลังตรวจสอบสิทธิ์...</p>
        </div>
      </div>
    )
  }
  ...
  if (!isRider) {
    return (
      <div className="flex h-screen w-full flex-col items-center justify-center bg-[#121214] p-6 text-center text-white">
        ...
        <h1 className="text-xl font-black tracking-tight mb-2">ไม่ได้รับสิทธิ์เข้าถึง</h1>
        <p className="text-xs text-zinc-400 leading-relaxed max-w-[280px] mb-6">
