    ...
    <div className="min-h-screen bg-white text-black pb-32 font-sans selection:bg-black selection:text-white">
        ...
        <div className="relative w-full h-64 sm:h-[320px] bg-black overflow-hidden shrink-0">
            ...
            {banners.length > 0 ? (
                ...
                <img crossOrigin="anonymous"  src={table.branch.image_url ? `${table.branch.image_url}?v=7` : ''} className="w-full h-full object-cover" />
            ) : null}
                            ...
                            {cart.map(item => (
                                ...
                                >
                                    <div className="w-20 h-20 bg-gray-50 flex-shrink-0 relative">
                                        {item.image_url ? <img crossOrigin="anonymous"  src={item.image_url ? `${item.image_url}?v=7` : ''} className="w-full h-full object-cover mix-blend-multiply" /> : <div className="absolute inset-0 flex items-center justify-center text-gray-200"><Utensils size={16} /></div>}
                                    </div>
