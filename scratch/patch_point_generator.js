...
// Replace everything inside the component
const componentStart = `export default function PointGenerator({ onClose }: { onClose?: () => void }) {`;
const componentEndRegex = /export default function PointGenerator[\s\S]*/;

const newComponent = `export default function PointGenerator({ onClose }: { onClose?: () => void }) {
...
code = code.replace(componentEndRegex, newComponent);
