...
const renderGraphicCanvasDirect = async (
  ...
  wrapper.style.cssText = `position: fixed; left: 0; top: 0; width: ${width}px; height: auto; overflow: hidden; z-index: 999999; opacity: 0.002; pointer-events: none; background: white;`;
  ...
  try {
    // Wait for the browser layout engine to paint and calculate dimensions
