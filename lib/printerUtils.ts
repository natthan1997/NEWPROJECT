...
const appendLoyaltyPointsQr = async (b: ESCPOSBuilder, order: PrintOrderData) => {
  ...
  const qrUrl = order.loyaltyClaimQrUrl || `https://api.qrserver.com/v1/create-qr-code/?size=240x240&data=${encodeURIComponent(`https://liff.line.me/${liffId}/liff/member?claimToken=${token}`)}`
